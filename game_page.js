...
function send(){
    ...
    characterat2=word.charAt(lenght_divide_2);
    lenght_minus_1=word.length-1;
    characterat3=word.charAt(lenght_minus_1);
    remove_charAt1=word.replace(characterat1,"_");
    remove_charAt2=remove_charAt1.replace(characterat2,"_");
    remove_charAt3=remove_charAt2.replace(characterat3,"_");
